...
class Manager
{
     ...
     * The provider.
     *
     * @var \Kladislav\JWTAuth\Contracts\Providers\JWT
     */
    protected $provider;
     ...
     * The blacklist.
     *
     * @var \Kladislav\JWTAuth\Blacklist
     */
    protected $blacklist;
     ...
     * Constructor.
     *
     * @param  \Kladislav\JWTAuth\Contracts\Providers\JWT  $provider
     * @param  \Kladislav\JWTAuth\Blacklist  $blacklist
     * @param  \Kladislav\JWTAuth\Factory  $payloadFactory
     *
     * @return void
     */
     ...
     *
     * @param  \Kladislav\JWTAuth\Payload  $payload
     *
     * @return \Kladislav\JWTAuth\Token
     */
     ...
     *
     * @param  \Kladislav\JWTAuth\Token  $token
     * @param  bool  $checkBlacklist
     *
     * @throws \Kladislav\JWTAuth\Exceptions\TokenBlacklistedException
     *
     ...
     *
     * @return \Kladislav\JWTAuth\Contracts\Providers\JWT
     */
